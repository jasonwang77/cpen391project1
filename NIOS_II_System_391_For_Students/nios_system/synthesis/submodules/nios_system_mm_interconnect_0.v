...
module nios_system_mm_interconnect_0 (
	...
	wire  [105:0] cmd_demux_001_src4_data;                                                            // cmd_demux_001:src4_data -> crosser_003:in_data
	wire          cmd_demux_001_src4_ready;                                                           // crosser_003:in_ready -> cmd_demux_001:src4_ready
	wire   [12:0] cmd_demux_001_src4_channel;                                                         // cmd_demux_001:src4_channel -> crosser_003:in_channel
	...
	wire  [105:0] crosser_003_out_data;                                                               // crosser_003:out_data -> cmd_mux_004:sink1_data
	wire          crosser_003_out_ready;                                                              // cmd_mux_004:sink1_ready -> crosser_003:out_ready
	wire   [12:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> cmd_mux_004:sink1_channel
	...
	wire   [12:0] rsp_demux_src0_channel;                                                             // rsp_demux:src0_channel -> crosser_004:in_channel
	...
	wire   [12:0] crosser_004_out_channel;                                                            // crosser_004:out_channel -> rsp_mux:sink0_channel
	...
	wire   [12:0] rsp_demux_src1_channel;                                                             // rsp_demux:src1_channel -> crosser_005:in_channel
	...
	wire   [12:0] crosser_005_out_channel;                                                            // crosser_005:out_channel -> rsp_mux_001:sink0_channel
	...
	wire  [105:0] rsp_demux_004_src0_data;                                                            // rsp_demux_004:src0_data -> crosser_006:in_data
	wire          rsp_demux_004_src0_ready;                                                           // crosser_006:in_ready -> rsp_demux_004:src0_ready
	wire   [12:0] rsp_demux_004_src0_channel;                                                         // rsp_demux_004:src0_channel -> crosser_006:in_channel
	...
	wire          crosser_006_out_valid;                                                              // crosser_006:out_valid -> rsp_mux:sink4_valid
	wire  [105:0] crosser_006_out_data;                                                               // crosser_006:out_data -> rsp_mux:sink4_data
	wire          crosser_006_out_ready;                                                              // rsp_mux:sink4_ready -> crosser_006:out_ready
	wire   [12:0] crosser_006_out_channel;                                                            // crosser_006:out_channel -> rsp_mux:sink4_channel
	wire          crosser_006_out_startofpacket;                                                      // crosser_006:out_startofpacket -> rsp_mux:sink4_startofpacket
	wire          crosser_006_out_endofpacket;                                                        // crosser_006:out_endofpacket -> rsp_mux:sink4_endofpacket
	wire          rsp_demux_004_src1_valid;                                                           // rsp_demux_004:src1_valid -> crosser_007:in_valid
	wire  [105:0] rsp_demux_004_src1_data;                                                            // rsp_demux_004:src1_data -> crosser_007:in_data
	wire          rsp_demux_004_src1_ready;                                                           // crosser_007:in_ready -> rsp_demux_004:src1_ready
	wire   [12:0] rsp_demux_004_src1_channel;                                                         // rsp_demux_004:src1_channel -> crosser_007:in_channel
	wire          rsp_demux_004_src1_startofpacket;                                                   // rsp_demux_004:src1_startofpacket -> crosser_007:in_startofpacket
	wire          rsp_demux_004_src1_endofpacket;                                                     // rsp_demux_004:src1_endofpacket -> crosser_007:in_endofpacket
	wire          crosser_007_out_valid;                                                              // crosser_007:out_valid -> rsp_mux_001:sink4_valid
	wire  [105:0] crosser_007_out_data;                                                               // crosser_007:out_data -> rsp_mux_001:sink4_data
	wire          crosser_007_out_ready;                                                              // rsp_mux_001:sink4_ready -> crosser_007:out_ready
	wire   [12:0] crosser_007_out_channel;                                                            // crosser_007:out_channel -> rsp_mux_001:sink4_channel
